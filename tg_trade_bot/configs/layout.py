LAYOUT = {
    ...
    "bingx": {
        ...
        "leverage": {"x": 0.29, "y": 0.20, "anchor": "lm"},
        "side_badge": {"x": 0.10, "y": 0.198, "anchor": "lm", "dx": 0, "dy": 0},
        ...
        # очистка
        "clear_symbol": {"x": 0.05, "y": 0.09, "w": 0.36, "h": 0.05},
        "clear_side_badge": {
            "x": 0.15,
            "y": 0.15,
            "w": 0.12,
...
BYBIT_CUSTOM_LAYOUT = {
    ...
    "bingx": {
        # кастомный BingX
        "username": {"x": 0.30, "y": 0.32, "anchor": "lm"},
        "referral": {"x": 0.05, "y": 0.18, "anchor": "lm"},
        "datetime": {"x": 0.30, "y": 0.20, "anchor": "lm"},
        ...
        "side_position": {"x": 0.50, "y": 0.335, "anchor": "lm"},
        "leverage_position": {"x": 0.50, "y": 0.335, "anchor": "lm"},
